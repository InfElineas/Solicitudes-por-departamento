        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <SummaryCard
              ...
              value={analytics.totals?.total_requests ?? 0}
              sub="Acumulado"
            />
            <SummaryCard
              icon={<Clock className="h-4 w-4 text-muted-foreground" />}
              label="Nuevas (<24h)"
              value={analytics.totals?.new_last_24h ?? 0}
            ...
            <SummaryCard
              ...
              value={analytics.pending_now}
              valueClass="text-blue-600"
            />
            <SummaryCard
              icon={<UserPlus className="h-4 w-4 text-muted-foreground" />}
              label="Solicitudes asignadas"
              value={analytics.totals?.assigned_total ?? 0}
              sub="Actualmente"
            />
            <SummaryCard
              icon={<Settings2 className="h-4 w-4 text-muted-foreground" />}
              label="Sin asignar"
              value={analytics.totals?.unassigned_total ?? 0}
              sub="Actualmente"
            />
            <SummaryCard
              icon={<TrendingUp className="h-4 w-4 text-muted-foreground" />}
              label="Tiempo Promedio"
              value={`${analytics.avg_cycle_hours}h`}
              sub="Ciclo de creación → cierre"
            />
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Asignadas (acumulado), Atendidas (finalizadas en el periodo) y
