...
const RequestFilters = ({
  ...
  return (
    <div className="bg-white border rounded-xl p-3 p-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      {/* Buscar */}
      <div className="col-span-2 md:col-span-4 lg:col-span-3 truncate">
      ...
      {/* Asignado a */}
      <div className="md:col-span-2 lg:col-span-1 truncate">
        <Label className="sr-only md:not-sr-only text-xs text-slate-500">
          Asignado a
        </Label>
        <Select
      ...
      {/* Orden */}
      <div className="md:col-span-3 lg:col-span-2 truncate">
        <Label className="sr-only md:not-sr-only text-xs text-slate-500">
          Orden
        </Label>
        <Select
